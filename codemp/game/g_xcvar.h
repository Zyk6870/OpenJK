...
XCVAR_DEF(zyk_magic_fist_damage,		"20", NULL, CVAR_ARCHIVE | CVAR_NORESTART, qtrue)
...
XCVAR_DEF(zyk_max_quest_npcs,			"32", NULL, CVAR_ARCHIVE | CVAR_NORESTART, qtrue)
...
XCVAR_DEF(zyk_initial_nature_energy,	"500", NULL, CVAR_ARCHIVE | CVAR_NORESTART, qtrue)
...
XCVAR_DEF(zyk_force_account_login, "0", NULL, CVAR_ARCHIVE | CVAR_NORESTART, qtrue)
