		...
		{ // zyk: player makes his choice near the end of the Universe Quest
			...
			else
			{
				if (Q_stricmp( target->NPC_type, "sage_of_universe" ) == 0)
				{
					...
					zyk_text_message(ent, "universe/mission_13/mission_13_sages", qtrue, qfalse);
				}
				else if (Q_stricmp( target->NPC_type, "guardian_of_universe" ) == 0)
				{
					...
					ent->client->pers.universe_quest_messages = 29;
					ent->client->pers.universe_quest_timer = level.time - 100;
					zyk_text_message(ent, "universe/mission_13/mission_13_guardians", qtrue, qfalse);
				}
				else if (Q_stricmp( target->NPC_type, "master_of_evil" ) == 0)
				{
					...
					ent->client->pers.universe_quest_messages = 29;
					ent->client->pers.universe_quest_timer = level.time - 100;
					zyk_text_message(ent, "universe/mission_13/mission_13_thor", qtrue, qfalse);
				}
				else if (Q_stricmp( target->NPC_type, "guardian_of_time" ) == 0)
				{
					...
					ent->client->pers.universe_quest_messages = 29;
					ent->client->pers.universe_quest_timer = level.time - 100;
					zyk_text_message(ent, "universe/mission_13/mission_13_time", qtrue, qfalse);
				}
				return;
			}
		}
